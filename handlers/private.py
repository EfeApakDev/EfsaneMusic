...
async def start(_, message: Message):
                ...
                "https://www.imagevisit.com/images/2022/07/29/20220729_202658.md.jpg",
                caption=(f"""**Merhaba {message.from_user.mention} 🎵\nBen {bot}!\nSesli sohbetlerde müzik çalabilen botum. Ban yetkisiz, Ses yönetimi yetkisi verip, Asistanı gruba ekleyiniz.\n\nDüzen Tasarım [Sancak Müzik 🎙️](https://t.me/SancakBotlar).**"""),
         reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "➕ ❰ Grubuna Ekle ❱ ➕", url=f"https://t.me/SancakMuzikBot?startgroup=true"
                    )
                ],
                [
                    InlineKeyboardButton(
                        "🔊 Asistan", url="https://t.me/sancakmuzikasistan"
                    ),
                    InlineKeyboardButton(
                        "💬 Sohbet", url="https://t.me/muhabbetofkings"
                    )
                ],
                [
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "Resmi Kanal 🇹🇷", url=f"https://t.me/Sancakbotlar"
                    )
                ]
      ...
      reply_markup=InlineKeyboardMarkup(
             [
                 [
                     ...
                     InlineKeyboardButton(
                         "⚙ Geliştirici", url="https://t.me/sancakbegi")
                 ]
             ]
         )
    )
